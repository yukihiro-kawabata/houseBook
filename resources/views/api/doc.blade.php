    ...
    <div id="main" class="panel panel-info">
        <div class="panel-heading">{{ $apiData->api_name }} description</div>
            <div class="panel-body">
                ...
                @if (empty($apiData->id))
                    <a href="{{ url('/regist/index') }}">
                        <button type="button" class="btn btn-primary pull-right" style="margin: 5px;">New regist API</button>
                    </a>
                @else
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ url('/api') . '?action=' . $apiData->api_name . '&db_name=' . $apiData->db_name }}" target="_blank">{{ url('/api') . '?action=' . $apiData->api_name . '&db_name=' . $apiData->db_name}}</a>
                    </div>
                    <div class="form-group">
